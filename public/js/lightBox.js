...
<script type="text/javascript">
    function ProImgShow(pid,price,Number,image,prizetype,prizeName) {
        ...
        ajaxCheck("temp1.html?price="+ price +"&ld="+prizetype+"&Number="+Number, "", function (responsetext) {
            if (responsetext == "NO") {
                prinumber = 1;
    ...
    function onclickSvem(prinumber,dj,price)
    {
      ...
      ajaxCheck("temp1.html?pid="+ pid +"&shuliang="+ shuliang +"&danjia="+ dj +"&RealName="+ escape(RealName) +"&CallTel="+ CallTel +"&UserAddress="+ escape(UserAddress) +"&price1="+price+"", "", function (responsetext) {
            if (responsetext == "ok") {
                alert("兑换成功!");
                window.location.href="UserShopList.html";
            }
            else {
              alert(responsetext);
            }
...
<div align="center"><a href="#" style="color:#808080;">上一页</a>&nbsp;&nbsp; 1/1 &nbsp;&nbsp;<a href="JpShop.html?page=1" style="color:#4FA3F7;">下一页</a></div>
</div>
</div>
