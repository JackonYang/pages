<script>alert('请先登录!');window.location.href = '../Default.aspx';</script><script>alert('请先登录!');window.location.href = '../Default.aspx';</script>
...
<script type="text/javascript">
    function onclickSvem() {
        ...
        ajaxCheck("temp2.aspx?nicheng=" + escape(nicheng) + "&shengr=" + escape(shengr) + "&RealName=" + escape(RealName) + "&province=" + escape(province) + "&city=" + escape(city) + "&jiedao=" + escape(jiedao) + "&xingbie=" + xingbie + "&beizhu=" + escape(beizhu) + "", "", function (responsetext) {
            if (responsetext == "OK") {
                alert("保存成功!");
...
<div style="margin-top:60px; margin-left:10px; font-size:14px; height:25px;"><table><tr><td style="height:25px; width:140px;">欢迎您 <span style="color:#0000CC;"></span></td><td><a href="../Default.aspx?tid=1"><img src="../images/anquantuic1.png" onmouseup="this.src='../images/anquantuic2.png'" onmousedown="this.src='../images/anquantuic3.png'" onmouseout="this.src='../images/anquantuic1.png'" onmouseover="this.src='images/anquantuic2.png'"/></a></td></tr></table></div>
...
<tr><td style="height:46px; font-size:14px;"><a href="../UsersMembers.aspx" style="color:#2A5DA9;">信息总览</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../UsersModification.aspx" style="color:#2A5DA9;">修改资料</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../Security.aspx" style="color:#2A5DA9;">账号安全</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../EditPassWord.aspx" style="color:#2A5DA9;">修改密码</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../EditBankPassWord.aspx" style="color:#2A5DA9;">修改口令</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../UserPayList.aspx" style="color:#2A5DA9;">充值记录</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../UserShopList.aspx" style="color:#2A5DA9;">兑换记录</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../UserTuiGame.aspx" style="color:#2A5DA9;">推广信息</a></td></tr>
<tr><td style="height:46px; font-size:14px;"><a href="../FeedBack.aspx" style="color:#2A5DA9;">我要反馈</a></td></tr>
</table>
</div>
</div>
</div>
...
<div style="padding-top:10px; text-align:right; padding-right:30px; width:400px; float:right; color:#2A5DA9;">您当前的位置是&nbsp;:&nbsp;首页&nbsp;>&nbsp;<a href="UsersMembers.aspx" style="color:#2A5DA9;">个人中心</a>&nbsp;>&nbsp;修改资料</div>
